...
import { CreateBookingAttendee } from './booking/pages/create/create-booking-attendee.component';
import { DetailsBookingComponent } from './booking/pages/details/details-booking.component';
...
export const CLIENT_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      { path: 'bookings/:bookingId', component: DetailsBookingComponent },
    ],
  },
];
