...
@Component({
  template: `
    <section class="flex flex-col px-6">
      ...
      <div
        class="border rounded-xl bg-white dark:bg-neutral-950/50 dark:border-neutral-800 border-gray-200/80 mt-8"
      >
        <div class="p-6">
        ...
        <div class="p-6 border-t dark:border-neutral-800 border-gray-200/80">
          ...
          <div class="relative mt-2">
            ...
            <input
              ...
              readonly
              (click)="copyLink()"
              class="w-full cursor-pointer rounded-lg border border-gray-300 bg-stone-100 py-2.5 pl-4 pr-28 text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-neutral-700 dark:bg-neutral-900 dark:text-gray-300"
            />
            ...
            <button
              type="button"
              (click)="copyLink()"
              class="absolute inset-y-0 right-0 my-1.5 mr-1.5 flex items-center gap-2 rounded-md bg-white px-3 text-sm font-semibold text-gray-600 ring-1 ring-inset ring-gray-300 transition-all hover:bg-stone-100 dark:bg-neutral-700 dark:text-gray-200 dark:ring-gray-600 dark:hover:bg-neutral-600"
